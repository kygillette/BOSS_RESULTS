...
Boss_Results_SS_Archive = r"C:\BossResults\OLD_BOSS_RESULTS"

#Boss results log
Boss_Results_Log_Path = r"C:\BossResults\OLD_BOSS_RESULTS\Boss_Results_log.txt"
    ...
    if SS == "OLD_BOSS_RESULTS":
        ...
        if LAST_HASH == SS_HASH:
            ...
            if "Summoned" in text:
                ...
                if ("Sanguineous" in text) or ("Sangvineous" in text) or ("Sangvineovs" in text) or ("Sanguineovs" in text):
